...
int main(int argc, char* argv[])
{
     ...
     */
    double* OwnedBlock = (double*) malloc(blockN * M * sizeof (double)); 
    double* ExchangedBlock = (double*) malloc(M * blockN * sizeof (double)); 
    ...
    for (int i = 0; i < steps; i++) {
        ...
        MPI_Sendrecv_replace((void*)ExchangedBlock, M * B, MPI_FLOAT, leftRank, 0, rightRank, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
    }
